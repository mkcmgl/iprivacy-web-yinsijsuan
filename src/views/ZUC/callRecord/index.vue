		...
		<el-card shadow="never" class="search-box">
			<div class="content">
				<div class="search-box clearfix">
					...
					<div class="fr">
						<el-button type="primary" size="large" @click="searchList" v-auth="'api:cipher:zuc:log:list'">
							<el-icon>
								<ele-Search />
							</el-icon>
							<span>查询</span>
						</el-button>
						<el-button type="info" size="large" @click="clearForm" v-auth="'api:cipher:zuc:log:list'">
							<el-icon>
								<ele-RefreshLeft />
							</el-icon>
							<span>重置</span>
...
<script setup lang="ts" name="ZUCCallRecord">
import { reactive, onMounted } from 'vue';
import { getZUCList } from '@/api/ZUC/callRecord';
